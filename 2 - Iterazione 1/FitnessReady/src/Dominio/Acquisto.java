...
public class Acquisto {
    ...
    //----Con id manuale----
    public Acquisto(int id, Date data, float totale){
        this.id = id;
        this.data = data;
        this.totale = totale;
    ...
    public Acquisto(int id, Date data, float totale, List<RigaAcquisto> righeAcquisto){
        this.id = id;
        this.data = data;
        this.totale = totale;
    ...
    //----Con id incrementale----
    public Acquisto(Date data, float totale){
        setId();
        this.data = data;
        this.totale = totale;
        righeAcquisto = new ArrayList<>();
    ...
    public Acquisto(Date data, float totale, List<RigaAcquisto> righeAcquisto){
        setId();
        this.data = data;
        this.totale = totale;
        this.righeAcquisto = righeAcquisto;
