...
public class AuthenticationTest {
    ...
    public void loginTest(){
        ...
        //Si possoo anche rimuovere le varibili "expectedN"
    ...
    public void signInTest(){
        assertThrows(ExistingEmailException.class, () -> {
            FR.registraCliente("Mario", "Nunez", "mR_95@live.it", "ciao", "ciao", "1.75", "75");
        });
        
        assertThrows(PasswordNotEqualsException.class, () -> {
            FR.registraCliente("Mario", "Nunez", "IL_MARIO@live.it", "ciao", "ciiao", "1.75", "75");
        });
        ...
        try{
            Cliente expectedClient = new Cliente(5, "Sara", "Marino", "revylaroche@yahoo.it", "ciao", (float)1.50, (float)45);
            FR.registraCliente("Sara", "Marino", "revylaroche@yahoo.it", "ciao", "ciao", "1.50", "45");
