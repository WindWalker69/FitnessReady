...
public class PurchaseTest {
    ...
    public static void setUpClass() {
        ...
        prod = new Prodotto("Oatbakes", "ALIMENTI", (float)17.49, (int)10);
    ...
    public void addToCartTest(){
        assertThrows(GenericSystemException.class, () -> {
            GA.aggiungiAlCarrello(new Prodotto("Oatbakes", "ALIMENTI", (float)17.49, (int)0), 0);
        });
        
        assertThrows(NotPositiveNumberException.class, () -> {
            GA.aggiungiAlCarrello(new Prodotto("Oatbakes", "ALIMENTI", (float)17.49, (int)10), 0);
        });
        
        assertThrows(Exception.class, () -> {
            GA.aggiungiAlCarrello(new Prodotto("Oatbakes", "ALIMENTI", (float)17.49, (int)10), 11);
        });
    ...
    public void executePurchaseTest(){
        ...
        try{
            ...
            Acquisto expectedAcquisto = new Acquisto(2, new Date(), (float)17.49, expectedRigheAcquisto); //id = 2 poiché con StartUp si ha già un acquisto in lista
            
            GA.aggiungiAlCarrello(prod, 1); //Aggiunta necessaria per via del setUp
            Acquisto actualAcquisto = GA.effettuaAcquisto();
